...
# Intents where keywords must match as whole words (avoid false matches)
...
RESPONSES = {
    ...
    "deepfake": (
        ...
        "India saw a 218% rise in deepfake political disinformation in 2024. "
        "Use the Deepfake Detector module to upload and analyse any suspicious video or image instantly."
    ),
    "voice": (
    ...
    "report": (
        ...
        "National Helpline 1930 (24×7) — call immediately for financial fraud. "
    ...
    "default": (
        ...
        "What would you like to know? You can also use the detection modules on the left "
